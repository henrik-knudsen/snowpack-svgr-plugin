import { createConfigItem, loadPartialConfig, transformAsync, } from "@babel/core";
...
module.exports = function (_snowpackConfig, _pluginOptions) {
    return {
        ...
        async load({ filePath }) {
            ...
            const code = await transform(contents, { icon: true, exportType: "named" }, { componentName: "ReactComponent" });
            const babelOptions = {
                babelrc: false,
                configFile: false,
                presets: [
